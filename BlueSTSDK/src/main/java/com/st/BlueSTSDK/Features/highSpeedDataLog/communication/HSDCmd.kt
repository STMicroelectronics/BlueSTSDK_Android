...
abstract class HSDControlCmd(command: String) : HSDCmd(command = command)

class HSDStartLoggingCmd : HSDControlCmd(command = "START")

class HSDStopLoggingCmd : HSDControlCmd(command = "STOP")
