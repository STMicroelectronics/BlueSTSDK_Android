...
class FeatureExtConfiguration constructor(n: Node) :
        Feature(FEATURE_NAME, n, arrayOf(FEATURE_EXT_CONF)) {
    ...
    fun writeCommandSetArgumentJSON(commandName: String, obj: Any) {
    ...
    companion object {
        ...
        fun resultCustomCommandList(responseObj: JsonObject?): List<CustomCommand>? {
            return ExtConfigParser.extractLCustomCommandList(responseObj)
        }
